...
export class CommandSubmissionPipeline {
    ...
    public submitForTransactionAsync(request: SubmitCommandRequest, options?: RequestOptions): Promise<SubmitCommandTransactionResponse> { if (!this.dependencies.transport.submitCommandForTransactionAsync) throw new NotSupportedError("transaction-returning command submission is not supported by the selected transport"); return this.dependencies.transport.submitCommandForTransactionAsync(request, options); }
