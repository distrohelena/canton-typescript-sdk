...
import {
    ...
    ListParticipantSynchronizerPermissionRequest as ProtobufListParticipantSynchronizerPermissionRequest,
    ...
    ListSequencingParametersStateRequest as ProtobufListSequencingParametersStateRequest,
...
export class GrpcTransport implements ITransport {
    ...
    public async listOwnerToKeyMappingAsync(
        request: ProtobufListOwnerToKeyMappingRequest,
        options?: RequestOptions,
    ): Promise<ProtobufListOwnerToKeyMappingResponse> {
        this.throwIfDisposed();
        ...
        return payload as ProtobufListOwnerToKeyMappingResponse;
    }
    ...
    public async listParticipantSynchronizerPermissionAsync(
        request: ProtobufListParticipantSynchronizerPermissionRequest,
        options?: RequestOptions,
    ): Promise<ProtobufListParticipantSynchronizerPermissionResponse> {
        this.throwIfDisposed();
        ...
        return payload as ProtobufListParticipantSynchronizerPermissionResponse;
    }
    ...
    public async listSynchronizerParametersStateAsync(
        request: ProtobufListSynchronizerParametersStateRequest,
        options?: RequestOptions,
    ): Promise<ProtobufListSynchronizerParametersStateResponse> {
        this.throwIfDisposed();
        ...
        return payload as ProtobufListSynchronizerParametersStateResponse;
    }

    public async listSequencingParametersStateAsync(
        request: ProtobufListSequencingParametersStateRequest,
        options?: RequestOptions,
    ): Promise<ProtobufListSequencingParametersStateResponse> {
        this.throwIfDisposed();
        ...
        return payload as ProtobufListSequencingParametersStateResponse;
    }
    ...
    public async listLsuSequencerConnectionSuccessorAsync(
        request: ProtobufListLsuSequencerConnectionSuccessorRequest,
        options?: RequestOptions,
    ): Promise<ProtobufListLsuSequencerConnectionSuccessorResponse> {
        this.throwIfDisposed();
        ...
        return payload as ProtobufListLsuSequencerConnectionSuccessorResponse;
    }
