...
/**
 * @generated from protobuf message com.daml.ledger.api.v2.Signature
 */
export interface Signature {
    /**
     * Required
     *
     * @generated from protobuf field: com.daml.ledger.api.v2.SignatureFormat format = 1
     */
     ...
     * Required
     *
     * @generated from protobuf field: com.daml.ledger.api.v2.SigningAlgorithmSpec signing_algorithm_spec = 4
     */
...
/**
 * @generated from protobuf enum com.daml.ledger.api.v2.SigningAlgorithmSpec
 */
...
/**
 * @generated from protobuf enum com.daml.ledger.api.v2.SignatureFormat
 */
...
class SigningPublicKey$Type extends MessageType<SigningPublicKey> {
    constructor() {
        super("com.daml.ledger.api.v2.SigningPublicKey", [
            { no: 1, name: "format", kind: "enum", T: () => ["com.daml.ledger.api.v2.CryptoKeyFormat", CryptoKeyFormat, "CRYPTO_KEY_FORMAT_"] },
            { no: 2, name: "key_data", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
            { no: 3, name: "key_spec", kind: "enum", T: () => ["com.daml.ledger.api.v2.SigningKeySpec", SigningKeySpec, "SIGNING_KEY_SPEC_"] }
        ]);
    }
}
/**
...
class Signature$Type extends MessageType<Signature> {
    constructor() {
        super("com.daml.ledger.api.v2.Signature", [
            { no: 1, name: "format", kind: "enum", T: () => ["com.daml.ledger.api.v2.SignatureFormat", SignatureFormat, "SIGNATURE_FORMAT_"] },
            { no: 2, name: "signature", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
            { no: 3, name: "signed_by", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 4, name: "signing_algorithm_spec", kind: "enum", T: () => ["com.daml.ledger.api.v2.SigningAlgorithmSpec", SigningAlgorithmSpec, "SIGNING_ALGORITHM_SPEC_"] }
        ]);
    }
}
/**
 * @generated MessageType for protobuf message com.daml.ledger.api.v2.Signature
 */
