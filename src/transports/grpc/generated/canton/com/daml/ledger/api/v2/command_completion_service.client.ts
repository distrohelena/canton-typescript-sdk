...
import type { GetCompletionsRequest } from "./command_completion_service.js";
...
export interface ICommandCompletionServiceClient {
     ...
     *
     * @generated from protobuf rpc: GetCompletions
     */
    getCompletions(input: GetCompletionsRequest, options?: RpcOptions): ServerStreamingCall<GetCompletionsRequest, CompletionStreamResponse>;
}
/**
 * Allows clients to observe the status of their submissions.
 * Commands may be submitted via the Command Submission Service.
...
export class CommandCompletionServiceClient implements ICommandCompletionServiceClient, ServiceInfo {
    ...
    getCompletions(input: GetCompletionsRequest, options?: RpcOptions): ServerStreamingCall<GetCompletionsRequest, CompletionStreamResponse> {
        ...
        return stackIntercept<GetCompletionsRequest, CompletionStreamResponse>("serverStreaming", this._transport, method, opt, input);
    }
}
