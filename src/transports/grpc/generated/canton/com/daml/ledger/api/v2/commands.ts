...
export interface Commands {
     ...
     * Optional
     *
     * @generated from protobuf field: optional uint32 taps_max_passes = 16
     */
...
class Commands$Type extends MessageType<Commands> {
    constructor() {
        super("com.daml.ledger.api.v2.Commands", [
            ...
            { no: 6, name: "deduplication_offset", kind: "scalar", oneof: "deduplicationPeriod", T: 3 /*ScalarType.INT64*/ },
            ...
            { no: 16, name: "taps_max_passes", kind: "scalar", opt: true, T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
}
/**
