...
export interface HealthListResponse {
    /**
     * @generated from protobuf field: map<string, grpc.health.v1.HealthCheckResponse.ServingStatus> statuses = 1
     */
    statuses: {
        [key: string]: HealthCheckResponse_ServingStatus;
    };
}
...
class HealthListResponse$Type extends MessageType<HealthListResponse> {
    constructor() {
        super("grpc.health.v1.HealthListResponse", [
            { no: 1, name: "statuses", kind: "map", K: 9 /*ScalarType.STRING*/, V: { kind: "enum", T: () => ["grpc.health.v1.HealthCheckResponse.ServingStatus", HealthCheckResponse_ServingStatus] } }
        ]);
    }
}
/**
