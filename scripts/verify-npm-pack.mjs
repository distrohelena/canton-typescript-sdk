...
const requiredLocalnetPackedPaths = Object.freeze([
    ...
    "package/node/start-local-splice-0.7.0.sh",
    "package/node/stop-local-splice-0.7.0.sh",
    "package/node/start-local-splice-0.6.14.sh",
    "package/node/stop-local-splice-0.6.14.sh",
    "package/node/start-local-splice-0.6.13.sh",
    "package/node/stop-local-splice-0.6.13.sh",
    "package/node/start-local-splice-0.6.12.sh",
    "package/node/stop-local-splice-0.6.12.sh",
    ...
    "package/node/test-start-local-splice-0.7.0.sh",
    "package/node/test-stop-local-splice-0.7.0.sh",
    "package/node/test-start-local-splice-0.6.14.sh",
    "package/node/test-stop-local-splice-0.6.14.sh",
    "package/node/test-start-local-splice-0.6.13.sh",
    "package/node/test-stop-local-splice-0.6.13.sh",
    "package/node/test-start-local-splice-0.6.12.sh",
    "package/node/test-stop-local-splice-0.6.12.sh",
